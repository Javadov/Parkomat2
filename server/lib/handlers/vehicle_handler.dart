...
class VehicleHandler {
  ...
  Router get router {
    ...
    router.get('/<registrationNumber>', (Request request, String registrationNumber) async {
      final vehicle = await repository.getByRegistrationNumber(registrationNumber);
      if (vehicle != null) {
